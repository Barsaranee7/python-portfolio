...
lab_am_txt=Label(clock,text="AM/PM",font=('Time New Roman',25,"bold"),bg='red',fg="white")
...
lab_day_txt=Label(clock,text="Day",font=('Time New Roman',25,"bold"),bg='red',fg="white")
